...
class AuthControllerValidationTest {
    ...
    @Test
    void signup_missingBody_badRequest() throws Exception {
    ...
    @Test
    void signup_whitespaceEmail_badRequest() throws Exception {
        mvc.perform(post("/auth/signup")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    void signup_whitespacePassword_badRequest() throws Exception {
        mvc.perform(post("/auth/signup")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    void signup_invalidEmailFormat_badRequest() throws Exception {
        mvc.perform(post("/auth/signup")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"email\":\"nonsense\",\"password\":\"p\"}"))
                .andExpect(status().isBadRequest());
    }

    @Test
    void signup_uppercaseEdu_normalized_ok() throws Exception {
    ...
    @Test
    void signup_overlongFields_badRequest() throws Exception {
    ...
    @Test
    void login_missingBody_badRequest() throws Exception {
